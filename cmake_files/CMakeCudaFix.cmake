...
MACRO(CUDA_ADD_EXECUTABLE_DC target src_files dependencies options linker_options)
	...
	#SET_TARGET_PROPERTIES(${target} PROPERTIES LINKER_LANGUAGE ${CUDA_C_OR_CXX} )
ENDMACRO(CUDA_ADD_EXECUTABLE_DC)
	
# Static device library
#CUDA_ADD_LIBRARY(dummy STATIC dummy.cu)
	
# Executable linking with the library
#CUDA_ADD_EXECUTABLE_DC(dummy_exe "${CMAKE_SOURCE_DIR}/src/dummy_exe.cu" "dummy" "" "")