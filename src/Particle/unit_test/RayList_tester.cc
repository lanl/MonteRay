...
SUITE( RayList_simple_tests ) {
    ...
    TEST( read_write ) {
        ParticleRayList write_list(10);
        CHECK_EQUAL( 10, write_list.capacity() );
        CHECK_EQUAL( 0, write_list.size() );
        ...
        std::string filename( "raylist_write_test1.bin" );
        write_list.writeToFile( filename );
